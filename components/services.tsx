...
const services = [
  ...
  },
  {
    ...
    title: "Custom Gates",
    description:
      "Durable and stylish custom metal gates designed to match your property’s security and aesthetic needs.",
  },
  {
    icon: <Zap className="w-8 h-8" />,
    title: "Fencing Solutions",
    description:
      "Strong and reliable fencing solutions built with high-quality materials for safety, privacy, and long-term durability.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mt-4">
            Comprehensive welding and metal fabrication solutions designed to
            meet your needs
          </p>
        </div>
